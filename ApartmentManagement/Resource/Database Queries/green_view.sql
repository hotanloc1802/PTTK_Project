...
VALUES
    ('GSR001', 'G01.01', 'R001', 'Plumbing', 'Garden irrigation system repair', 'In Progress', 180, CURRENT_TIMESTAMP - INTERVAL '15 days', NULL),
    ('GSR002', 'G01.02', 'R002', 'Electrical', 'Outdoor lighting installation', 'In Progress', 150, CURRENT_TIMESTAMP - INTERVAL '29 days', NULL),
    ('GSR003', 'G02.03', 'R003', 'HVAC', 'Green roof ventilation system', 'In Progress', 460, CURRENT_TIMESTAMP - INTERVAL '17 days', NULL),
    ('GSR004', 'G02.04', 'R004', 'Cleaning', 'Solar panel cleaning', 'In Progress', 120, CURRENT_TIMESTAMP - INTERVAL '34 days', NULL),
    ('GSR005', 'G03.05', 'R005', 'Security', 'Eco-friendly access system', 'In Progress', 230, CURRENT_TIMESTAMP - INTERVAL '12 days', NULL),
    ('GSR006', 'G03.06', 'R006', 'Maintenance', 'Balcony garden setup', 'In Progress', 410, CURRENT_TIMESTAMP - INTERVAL '25 days', NULL),
    ('GSR007', 'G04.07', 'R007', 'Plumbing', 'Rainwater collection system', 'In Progress', 280, CURRENT_TIMESTAMP - INTERVAL '44 days', NULL),
    ('GSR008', 'G04.08', 'R008', 'Electrical', 'Energy-efficient appliance setup', 'In Progress', 340, CURRENT_TIMESTAMP - INTERVAL '21 days', NULL),
    ('GSR009', 'G05.09', 'R009', 'HVAC', 'Geothermal system maintenance', 'In Progress', 500, CURRENT_TIMESTAMP - INTERVAL '61 days', NULL),
    ('GSR010', 'G05.10', 'R010', 'Cleaning', 'Green space maintenance', 'In Progress', 160, CURRENT_TIMESTAMP - INTERVAL '14 days', NULL);

-- Now, update some service requests to 'Completed' to trigger bill creation
UPDATE green_view.service_requests
SET status = 'Completed'
WHERE request_id IN ('GSR001', 'GSR002', 'GSR003', 'GSR004', 'GSR005', 'GSR006');

-- Test the accumulation for an existing pending service bill
-- Let's say GSR001 gets another related service completed
INSERT INTO green_view.service_requests (
    request_id, apartment_id, resident_id, category, description, status, amount, request_date, completed_date
)
VALUES
    ('GSR011', 'G01.01', 'R001', 'Plumbing', 'Follow-up irrigation optimization', 'In Progress', 95, CURRENT_TIMESTAMP - INTERVAL '1 day', NULL);

UPDATE green_view.service_requests
SET status = 'Completed'
WHERE request_id = 'GSR011';
